...
const SHELL = [
  ...
  "./styles.css?v=0.6.7",
  "./app.js?v=0.6.7",
  "./analysis-engine.js?v=0.6.7",
  "./analysis-worker.js?v=0.6.7",
  "./audio-worklet.js?v=0.6.7",
  "./live-state.js?v=0.6.7",
  "./live-runtime.js?v=0.6.7",
  "./history.js?v=0.6.7",
  "./upload-safety.js?v=0.6.7",
  "./microphone-startup.js?v=0.6.7",
  "./pwa.js?v=0.6.7",
