...
const SHELL = [
  ...
  "./styles.css?v=0.6.6",
  "./app.js?v=0.6.6",
  "./analysis-engine.js?v=0.6.6",
  "./analysis-worker.js?v=0.6.6",
  "./audio-worklet.js?v=0.6.6",
  "./live-state.js?v=0.6.6",
  "./live-runtime.js?v=0.6.6",
  "./history.js?v=0.6.6",
  "./upload-safety.js?v=0.6.6",
  "./microphone-startup.js?v=0.6.6",
  "./pwa.js?v=0.6.6",
