...
const SHELL = [
  ...
  "./styles.css?v=0.6.8",
  "./app.js?v=0.6.8",
  "./analysis-engine.js?v=0.6.8",
  "./analysis-worker.js?v=0.6.8",
  "./audio-worklet.js?v=0.6.8",
  "./live-state.js?v=0.6.8",
  "./live-runtime.js?v=0.6.8",
  "./history.js?v=0.6.8",
  "./upload-safety.js?v=0.6.8",
  "./microphone-startup.js?v=0.6.8",
  "./pwa.js?v=0.6.8",
